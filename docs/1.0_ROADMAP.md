# RasEyes — Development Roadmap (v1.0)
...
| 6-2 | CSV 로그 추출 및 FPS 방어율·평균 CPU 온도·알람 빈도 분석 | ➡️ `2.0_ROADMAP.md` Phase 2로 이관 |
...
**Phase 6 완료 기준:** 실내 착용 테스트 및 오디오 UX 의사결정 완료. ✅ **달성** (6-2 CSV 로그 분석은 로그 동기화 인프라와 함께 `2.0_ROADMAP.md` Phase 2로 이관)
...
Phase 6  ──✅── PoC 베타 테스트 (6-2 CSV 분석은 2.0으로 이관)
